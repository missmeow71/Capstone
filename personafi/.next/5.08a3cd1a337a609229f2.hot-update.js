...
/* harmony default export */ __webpack_exports__["a"] = (function (_ref) {
  ...
  if (loading) return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["j" /* Loader */], {
    active: true,
    inline: "centered",
    __source: {
  ...
  if (completed) return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["l" /* Message */], {
    success: true,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    }
  }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["l" /* Message */].Header, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    }
  ...
  if (items.length === 0) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["l" /* Message */], {
      warning: true,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 17
  ...
  var mapCartItemsToItems = function mapCartItemsToItems(items) {
    return items.map(function (_ref2) {
      ...
      return {
        ...
        }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["h" /* Item */].Header, {
          as: "a",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 31
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["h" /* Item */].Group, {
    divided: true,
...
/* harmony default export */ __webpack_exports__["a"] = (function (_ref) {
  ...
  }, "Sub Total:"), " ", formatted, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_semantic_ui_react__["a" /* Button */], {
    color: "orange",
    floated: "right",
    __source: {
      fileName: _jsxFileName,
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 3;
                  return Object(__WEBPACK_IMPORTED_MODULE_5__lib_moltin__["h" /* removeFromCart */])(itemId, cartId);
...
//# sourceMappingURL=5.08a3cd1a337a609229f2.hot-update.js.map